            ...
            {{-- <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4"> --}}
                ...
                <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
                    ...
                    <div class="flex justify-center xl:w-1/2">
                        <img class="h-80 " src="{{ $activity->image }}" alt="imagen">
                    </div>
                    ...
                    <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
                        ...
                        <p class="block max-w-2xl mt-4 text-xl text-gray-500 dark:text-gray-300">{{$activity->fecha_event}} </p>
                        
                        <div class="mt-6 sm:-mx-2">
                            <p class="text-gray-500 dark:text-gray-300">{{ $activity->description}}</p>
                            <p class="text-gray-500 dark:text-gray-300">{{$activity->phone_number}}</p>
                            <p class="text-gray-500 dark:text-gray-300">{{ $activity->place}}</p>
                        </div>
                        @if (auth()->user()->roles[0]->name == 'admin')
                        <div class="flex mt-3 -mx-2">
                            <a href="{{ route('activity.edit', $activity) }}" type="button"
